...
namespace hundun.unitygame.adapters
{
    ...
    public class GdxAnimation<T>
    {
        ...
        public GdxAnimation(float frameDuration, List<T> keyFrames)
        {
        ...
        public GdxAnimation(float frameDuration, List<T> keyFrames, PlayMode playMode)
        ...
        public int getKeyFrameIndex(float stateTime)
        {
            ...
            switch (playMode)
            {
                ...
                case PlayMode.LOOP_RANDOM:
                    ...
                    {
                        frameNumber = Random.Range(0, keyFrames.Count - 1);
                    }
                    else
                    {
        ...
        protected void setKeyFrames(List<T> keyFrames)
        {
